...
-   A operação de tratamento é realizada no território nacional: Isso significa que qualquer empresa ou órgão, independentemente de sua nacionalidade, que tratar dados pessoais dentro do Brasil estará sujeito à LGPD.
...
## Órgãos de Tratamento de Dados segundo a LGPD

## Agência Nacional de Proteção de Dados (ANPD)

- **Função:** Autoridade reguladora responsável por fiscalizar e orientar o cumprimento da LGPD.
- Estabelece diretrizes e normas complementares.
- Fiscaliza e aplica sanções em casos de descumprimento da lei.
- Recebe denúncias e reclamações sobre o tratamento de dados.
- Promove educação e conscientização sobre proteção de dados.

## Controlador

- **Função:** Responsável por tomar decisões sobre o tratamento de dados pessoais.
- Define as finalidades e os meios do tratamento.
- Garante o cumprimento da LGPD dentro da organização.
- Responde legalmente pelo tratamento inadequado dos dados.
- **Exemplo:** Uma empresa que coleta e usa dados dos clientes para marketing.

## Operador

- **Função:** Trata dados pessoais em nome do controlador, seguindo suas instruções.
- Realiza operações como armazenamento, processamento e análise.
- Não toma decisões sobre o tratamento de dados.
- **Exemplo:** Uma empresa terceirizada que processa a folha de pagamento de funcionários.

## Encarregado (Data Protection Officer - DPO)

- **Função:** Ponto de contato entre empresa, titulares de dados e a ANPD.
- Responde dúvidas dos titulares de dados.
- Auxilia na implementação da LGPD dentro da organização.
- Atua como intermediário em auditorias e investigações.
- **Exemplo:** Um profissional indicado por uma empresa para responder solicitações de clientes sobre o uso de seus dados.

## Titular dos Dados

- **Função:** Pessoa a quem os dados pessoais pertencem.
- Tem direitos garantidos pela LGPD, como acesso, correção e exclusão de dados.
- Pode questionar e solicitar informações sobre o tratamento de seus dados.

## Conclusão

- Cada agente tem um papel essencial na proteção de dados.
- O cumprimento da LGPD garante mais segurança e transparência no uso de informações pessoais.
- A ANPD é responsável por fiscalizar e garantir o cumprimento da lei.
